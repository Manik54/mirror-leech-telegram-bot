...
def stats(update, context):
    ...
    stats = f'<b>⏳Bot Uptime:</b> {currentTime}\n\n'\
            ...
            f'<b>🕹️RAM:</b> {mem_p}%\n'\
            f'<b>📀DISK:</b> {disk}%\n\n'\
            f'<b>🗄️Physical Cores:</b> {p_core}\n'\
            f'<b>🗒️Total Cores:</b> {t_core}\n\n'\
...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("💡 Repo 💡", "https://github.com/Manik54/mirror-leech-telegram-bot")
    buttons.buildbutton("🎭 Report Group 🎭", "https://t.me/+g_YPJYvkBpI0MTll")
